...
// Array to create card identities
var cards = ['king', 'queen', 'queen', 'king', 'queen', 'queen', 'king', 'king'];
...
function isTwoCards() {
  ...
  cardsInPlay.push(this.getAttribute('data-card'));
	...
	// show king image
		...
		//else show queen image	
		} else {
		this.innerHTML = "<img src='images/queenhearts.png'>";
		}
